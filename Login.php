...
<body>
    <div class="login">
        ...
        <form action="" method="POST">
            ...
            <input class="border border-secondary" type="email" name="Email" required placeholder="Email"><br>
            <input class="border border-secondary" type="date" name="DOB" required placeholder="Date Of Birth"><br>
            <input class="border border-secondary" type="password" name="Password" required placeholder="Password"><br>
            <button style="margin-bottom:2rem;" class="btn btn-success" type="submit" name="submit" >Submit</button><br>
            <!--<a class="bg-warning" href="admin.php">or Admin Login?</a>-->   
        </center>
        </form> 
    </div>
